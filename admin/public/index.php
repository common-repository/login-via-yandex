        ...
        <div class="grid-item b">
            <div class="content">
                ...
                <div class="help">
                    ...
                    <p>Не переживай, мы с тобой! Первым делом загляни в документацию на GitHub – там много полезной
                    ...
                    <ul>
                        ...
                        <li class="docs-item">
                            <a class="docs-link" href="https://github.com/dllpl/login-via-yandex-wp"
                               target="_blank">
                                    <span class="docs-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
